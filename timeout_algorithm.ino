...
void loop()
{
    ...
    if (dist < 20)
    {
      ...
      } while(dist < 50 && currentMillis - startMillis <= 3000); // If one of the conditions is false, exit while loop
      ...
      // In this case, exit the nested loop so that the claw can pick up the object again
